            ...
            didOpen: () => {
                ...
                function updatePreview() {
                    ...
                    if (selectedBadge) {
                        ...
                        // Add new color class
                        const newColorClass = colorClasses[selectedBadge.color] || 'bg-blue-100 text-blue-700 border-blue-200';
                        newColorClass.split(' ').forEach(cls => preview.classList.add(cls));
